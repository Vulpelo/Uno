...
<div class="container">
    	<div class="row">
			<div class="col-md-6 col-md-offset-3 loginSetting">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
                                ...
                                <form id="login-form" action="?page=login" method="post" role="form" style="display: block;">
									<div class="form-group">
								...
								<form id="register-form" action="?page=register" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="username" id="register-name" tabindex="1" class="form-control" placeholder="Username" value="">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<button type="button" class="form-control btn btn-register" onclick="registerUser()">Register Now</button>
